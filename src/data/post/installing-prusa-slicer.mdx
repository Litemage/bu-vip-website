...
title: How to Install Prusa Slicer
excerpt: Tutorial for installing Prusa slicer and configuring for Mk4s Printer
image: ~/assets/images/prusa-slicer-cover.png
category: Tutorials
tags:
  - 3d-printing
---
...
FDM 3D printers work by squeezing filament out of a nozzle attached to a heater, drawing lines accross a print bed 
...
![picture of mk4s printer with mmu3 upgrade](~/assets/images/mk4s-mmu3.png)
...
![screenshot of opening the file explorer](~/assets/images/prusa-click-install.png)
...
![screenshot of successful Prusa Slicer install](~/assets/images/psi-step-1.png)

The Installer should start and present you with this screen:

![blank prusa slicer](~/assets/images/ps-blank.png)

You'll want to go to the top menu and click: **Configuration -> Configuration Wizard**
which should present you with this screen:

![config wizard first step](~/assets/images/ps-config-wizard.png)

Click on **Prusa Research** on the left:

![click prusa research](~/assets/images/ps-config-2.png)
...
![click prusa research](~/assets/images/ps-config-3.png)
...
![printables show how to print](~/assets/images/printables-1.png)
...
![printables show how to print](~/assets/images/printables-2.png)
...
![printables show how to print](~/assets/images/printables-3.png)

Now, click "Slice" in the bottom right corner of PrusaSlicer and your model should now change to look like this:

![printables show how to print](~/assets/images/printables-4.png)
